...
import {get_number_in_range} from '../utils/io_utils.js'
...
function main(){
    ...
    let opcao = get_number_in_range(menu_de_opcoes())
    ...
    while(opcao != 0){
        if (opcao === 1){
            ...
            const palavras_sem_e = has_no_e(linhas)
            listar_palavras(palavras_sem_e, 'Palavras sem e', linhas.length)
        }
    }
}
